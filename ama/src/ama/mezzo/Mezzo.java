...
public class Mezzo {
	...
	private Politica politica; // per mezzi che seguono una politica
...
//	}
	...
	public String toString() {
		return "Mezzo [zonaDiRaccolta=" + zonaDiRaccolta + ", politica=" + politica + ", posizione="
				+ posizione + ", carico=" + carico + "]";
	}
